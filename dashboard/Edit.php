...
?>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="form-group col-4">
                    ...
                    <input type="text"  value="<?php echo $qfetch['name']; ?>" name="name" class="form-control" id="a" placeholder="Enter Your Name">
                  </div>


                  <div class="form-group col-4">
                    <label for="b">Father/Husband Name</label>
                    <input type="text" value="<?php echo $qfetch['father_husband_name']; ?>" name="father_husband_name" class="form-control" id="b"
 ...
 -->
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="number"  value="<?php echo $qfetch['age']; ?>" name="age" class="form-control" id="c" placeholder="Enter Your Age">
                  </div>
                  ...
                  <div class="form-group col-6">
                    <div class=" mb-4">
                      ...
                      <div class="form-check form-check-inline">
                        <input class="form-check-input"  <?php  if($qfetch['gender'] == "male"){?> checked <?php } ?> type="radio" name="gender" id="d" value="male">
                        <label class="form-check-label" for="d">Male</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input"  <?php  if($qfetch['gender'] == "female"){?> checked <?php } ?> type="radio" name="gender" id="e" value="female">
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="number"  value="<?php echo $qfetch['mr_no']; ?>" name="mr_no" class="form-control" id="f" placeholder="Enter Your MR NO">
                  </div>
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="date" value="<?php echo $qfetch['date']; ?>" name="date" class="form-control" id="g" placeholder="Enter Your Date">
                  </div>
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="text" value="<?php echo $qfetch['cnic_no']; ?>" name="cnic_no" class="form-control" data-inputmask="'mask': '99999-9999999-9'"
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="date"  value="<?php echo $qfetch['date_of_birth']; ?>" name="date_of_birth" class="form-control" id="i"
