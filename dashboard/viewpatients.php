                        ...
                        <div class="margin">
                          <div class="btn-group">
                            ...
                            <div class="dropdown-menu" role="menu">
                              <a class="dropdown-item"  href="Edit.php?skDelId=<?php echo $data[0]; ?>"><i class="fa fa-pencil" style="color:blue"></i>  EDIT</a><br>
                              <a class="dropdown-item" href="viewpatients.php?skDelId=<?php echo $data[0]; ?>"
                                onclick="return confirm('Are you Sure You Want to delete this?')"><i class="fa fa-trash" style="color:red"></i>  DELETE</a><br>
                              <a class="dropdown-item" href="viewrecord.php?skDelId=<?php echo $data[0]; ?>"><i class="fa fa-eye" style="color:orange"></i> VIEW</a>
